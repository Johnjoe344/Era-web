...
// Single-file React landing page for a Wholesaling Real Estate company
// Brand: ERA Property Solutions
// Colors: Navy (#0B2D45) + Red (#E33D2E)
...
// Replace this with your GoHighLevel (or other CRM) inbound webhook URL.
// Example (GHL): https://hooks.leadconnectorhq.com/webhook/XXXXXXXX
...
// We'll add a new PropertyEvaluationForm
...
export default function Website() {
  return (
    <div className="font-sans text-slate-900 scroll-smooth">
      ...
      {/* ... existing sections (how it works, compare, testimonials, etc.) */}
    </div>
  );
}
